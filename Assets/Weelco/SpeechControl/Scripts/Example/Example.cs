...
namespace Weelco.SpeechControl {
    ...
    public class Example : MonoBehaviour {
        ...
        public bool yesDetected, sonResponseDetected, doctorResponseDetected;
        ...
        private void onTranslateComplete(string response) {
            ...
            print(response);
            if (response.Contains("yes") && SceneManager.GetActiveScene().name == "School")
            {
                yesDetected = true;
            }
            if (response.Contains("proud") && SceneManager.GetActiveScene().name == "House")
            {
                sonResponseDetected = true;
            }
            if (response.Contains("recovery") && SceneManager.GetActiveScene().name == "Hospital")
            {
                doctorResponseDetected = true;
            }
